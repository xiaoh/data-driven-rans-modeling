...
class postPlot:
    ...
    def __init__(self, mainInput, onePtCoord):
        ...
        self.RComponentDir = 'RComponent_samples/'
        self.onePtCoord = onePtCoord
        ## load C1 C2 related data
        #pdb.set_trace()
        self.C1Fields = np.loadtxt(self.resultDir+self.RComponentDir+'XC1_s')
        self.C2Fields = np.loadtxt(self.resultDir+self.RComponentDir+'XC2_s')
        self.C1Field_base = np.loadtxt(self.resultDir+self.RComponentDir+'XC1_base')
        self.C2Field_base = np.loadtxt(self.resultDir+self.RComponentDir+'XC2_base')
    ...
    def plotTau1LocSamplesOnBay(self, caseName):
        ...
        plt.plot(xDns, yDns, 'D', markersize=10, color='blue',alpha=1)
        if legendFlag == 'True':    
        ...
        fname = figurefolder + 'bay_idx_'+str(idx_loc)+'_RMT_'+ caseName +'.pdf'
        plt.savefig(fname)
    ...
    def plotTau1LocContourOnBay(self, caseName):
        ...
        # self._plotDomain(subfig)
        fname = figurefolder + 'bayContour_idx_'+str(idx_loc)+'_RMT_'+ caseName +'.pdf'
        plt.savefig(fname)
    ...
    def plotScalarStat_1Loc(self, scalarFields, scalarName, caseName, CDFFlag='False',
        ...
        if scalarName in ['c1', 'c2', 'c3', 'XC1', 'XC2', 'Xi', 'Eta', 'TKE', 'VA', 'VB', 'VC']:
            scalar_base = np.loadtxt(self.resultDir+self.RComponentDir+scalarName+'_base')
            if scalarName == 'TKE':
        ...
        fname = figurefolder + scalarName+'_pdf_'+str(idx_loc)+'_RMT_'+ caseName +'.pdf'
        plt.savefig(fname)
...
if __name__ == '__main__':
    ...
    if plotAllTauComponents or plotAllNonDeltaComponents or plotC:
        ...
        c1Fields = np.loadtxt(resultDir+'RComponent_samples/'+'c1_s')
        ...
        c2Fields = np.loadtxt(resultDir+'RComponent_samples/'+'c2_s')
        ...
        c3Fields = np.loadtxt(resultDir+'RComponent_samples/'+'c3_s')
    ...
    if plotAllTauComponents or plotAllNonDeltaComponents or plotXiEta:
        ...
        XiFields = np.loadtxt(resultDir+'RComponent_samples/'+'Xi_s')
        ...
        EtaFields = np.loadtxt(resultDir+'RComponent_samples/'+'Eta_s')
    ...
    if plotAllTauComponents or plotAllNonDeltaComponents or plotTKE:
        ...
        TKEFields = np.loadtxt(resultDir+'RComponent_samples/'+'TKE_s')
        # normalization
        Ub = 0.028
    ...
    if plotAllTauComponents or plotAllNonDeltaComponents or plotTheta:
        ...
        VAFields = np.loadtxt(resultDir+'RComponent_samples/'+'VA_s'); VAFields = 180.0*VAFields/np.pi
        VBFields = np.loadtxt(resultDir+'RComponent_samples/'+'VB_s'); VBFields = 180.0*VBFields/np.pi
        VCFields = np.loadtxt(resultDir+'RComponent_samples/'+'VC_s'); VCFields = 180.0*VCFields/np.pi
    ...
    if plotAllTauComponents or plotAllDeltaComponents or plotDeltaXiEta:
        ...
        deltaXiFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaXi_s')
        ...
        deltaEtaFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaEta_s')
    ...
    if plotAllTauComponents or plotAllDeltaComponents or plotDeltaLnK:
        ...
        kde_bw = 0.2
        deltaKFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaK_s')
    ...
    if plotAllTauComponents or plotAllDeltaComponents or plotDeltaTheta:
        ...
        deltaVAFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaVA_s'); deltaVAFields = 180.0*deltaVAFields/np.pi
        deltaVBFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaVB_s'); deltaVBFields = 180.0*deltaVBFields/np.pi
        deltaVCFields = np.loadtxt(resultDir+'deltaRComponent_samples/'+'deltaVC_s'); deltaVCFields = 180.0*deltaVCFields/np.pi
